...
class CategorySeeder extends Seeder
{
    public function run()
    {
        ...
        $menSubCategories = [
            ...
            ['name' => 'Giày Dép Nam', 'slug' => 'giay-dep-nam', 'parent_id' => 1],
            ['name' => 'Phụ Kiện Nam', 'slug' => 'phu-kien-nam', 'parent_id' => 1],
        ];
        ...
        $womenSubCategories = [
            ...
            ['name' => 'Trang Sức', 'slug' => 'trang-suc', 'parent_id' => 2],
        ];
        ...
        $electronicSubCategories = [
            ...
            ['name' => 'Tivi', 'slug' => 'tivi', 'parent_id' => 3],
        ];
        ...
        $homeSubCategories = [
            ...
            ['name' => 'Đồ Gia Dụng Nhỏ', 'slug' => 'do-gia-dung-nho', 'parent_id' => 4],
        ];
